    ...
    public void CriarContaPoupanca(String nome) {
        for (Banco conta : this.contas) {
            if (conta.getNomeCliente().equals(nome)) {
                ...
                conta.CriarContaPoupanca(numeroDeConta, 1776,"Nubank", saldo,  dia, 0.05 );
            }
        }
    }
    ...
    public void CriarContaCorrente(String nome) {
        for (Banco conta : this.contas) {
            if (conta.getNomeCliente().equals(nome)) {
                ...
                conta.CriarContaCorrente(numeroDeConta, 1881, "Nubank", saldo, cheque);
    ...
    public void CriarContaSalario(String nome) {
        for (Banco conta : this.contas) {
            if (conta.getNomeCliente().equals(nome)) {
                ...
                conta.CriarContaSalario(numeroDeConta, 3232, "Nubank",saldo, saques);
            }
        }
    }
